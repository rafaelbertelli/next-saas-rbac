...
-- AddForeignKey
ALTER TABLE "billing_info" ADD CONSTRAINT "billing_info_organizationId_fkey" FOREIGN KEY ("organizationId") REFERENCES "organizations"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
